...
express()
  ...
  .set('view engine', 'ejs')
  .get('/', (req, res) => res.render('/Matkaklubi/views/pages/index.ejs'))
  .get('/contact', (req, res) => res.render('/Matkaklubi/views/pages/contact.ejs'))
  .get('/treks', (req, res) => res.render('/Matkaklubi/views/pages/treks.ejs', { matkad: matkad }))
  .get('/news', (req, res) => res.render('/Matkaklubi/views/pages/news.ejs'))
